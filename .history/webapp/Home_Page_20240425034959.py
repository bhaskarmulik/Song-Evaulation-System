...
def main():
    ...
    st.markdown(
        """
        <h3 style='text-align: left; color: white;'>Welcome to the Song Evaluation System. This system allows you to evaluate songs based on various criteria.To get started, click the Evaluation Page in the sidebar.</h3>"""
    ...
    st.markdown(
        """
        <p style='text-align: center; color: white;'>🚀How it works</p>
        """
    , unsafe_allow_html=True)
