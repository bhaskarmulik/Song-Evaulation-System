...
def main():
    ...
    st.markdown(
        """
        <p style='text-align: left; color: white;'>Welcome to the Song Evaluation System. This system allows you to evaluate songs based on various criteria.To get started, click the Evaluation Page in the sidebar.</p>"""
