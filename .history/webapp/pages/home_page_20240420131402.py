...
def switch_page(page_name: str):
    ...
    pages = get_pages("home_page")  # OR whatever your main page is called
    print("lel",pages)
    ...
    page_name = ['evaluation_page', 'results_page', 'home_page']
    print("lel",page_names)
