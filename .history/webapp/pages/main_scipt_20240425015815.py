...
def main():
    ...
    st.markdown(
        """
        <div class="navbar">
            <img src="D:\Yash Mulik Study\Mini-Project\github_codespace\Song-Evaulation-System\Images\background.jpeg" alt="Logo" class="navbar-logo">
            <div class="navbar-menu">
                <div class="menu-item" onclick="location.href='.';">Home</div>
                <div class="menu-item" onclick="location.href='#about';">About the Project</div>
