...
def main():
    ...
    st.markdown(
        """
        <div class="navbar">
            <img src="https://your-logo-url.com/logo.png" alt="Logo" class="navbar-logo">
            <div class="navbar-menu">
                <div class="menu-item" onclick="location.href='.';">Home</div>
                <div class="menu-item" onclick="scrollToAbout();">About the Project</div>
                <div class="menu-item" onclick="location.href='#contact';">Contact Us</div>
            </div>
        </div>
        """
    , unsafe_allow_html=True)
    ...
    st.markdown(
        ...
        <div id="about">
            ...
            <p>This project aims to provide a comprehensive evaluation system for songs. It leverages state-of-the-art audio processing techniques to analyze various aspects of music, including pitch, energy, and frequency.</p>"
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    # Inject JavaScript to enable smooth scrolling to the About section
    st.markdown(
        """
        <script>
